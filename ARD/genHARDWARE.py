...
def getConfig(filePath):
    ...
    texOut += genHARDWARETex(PTs, TCs, RTDs, HEs)
    texOut += "\\newpage\n"
...
def genHARDWARETex(PTs, TCs, RTDs, HEs):
    ...
    for PT in PTs:
        ...
        texOut += "Data Frequency & " + PT['Data Frequency'] + "Hz\\\\\hline\n"
    ...
    for TC in TCs:
        ...
        texOut += "Data Frequency & " + TC['Data Frequency'] + "Hz\\\\\hline\n"
    ...
    for RTD in RTDs:
        ...
        texOut += "Data Frequency & " + RTD['Data Frequency'] + "Hz\\\\\hline\n"
    ...
    for HE in HEs:
        ...
        texOut += "Input Voltage Range & " + PT['Min Input Voltage'] + " to " + PT['Max Input Voltage'] + " Volts\\\\\hline\n"
        texOut += "Data Frequency & " + HE['Data Frequency'] + "Hz\\\\\hline\n"
